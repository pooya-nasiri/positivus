  ...
  return (
    <header className=' relative w-full bg-white'>
        ...
        <div>
            ...
            <nav>
                <ul className='sm:text-[clamp(0.2rem,1.8vw,5rem)] hidden sm:flex-1/2 sm:flex lg:text-lg lg:space-x-5 xl:text-2xl items-center'>
                <li><Link href='/' className='focus:bg-f1 hover:bg-f1 p-1 rounded-lg px-1.5'>About Us</Link></li>
                <li><Link href='/' className='focus:bg-f1 hover:bg-f1 p-1 rounded-lg px-1.5'>Services</Link></li>
                <li><Link href='/' className='focus:bg-f1 hover:bg-f1 p-1 rounded-lg px-1.5'>Use Cases</Link></li>
                <li><Link href='/' className='focus:bg-f1 hover:bg-f1 p-1 rounded-lg px-1.5'>Pricing</Link></li>
                <li><Link href='/' className='focus:bg-f1 hover:bg-f1 p-1 rounded-lg px-1.5'>Blog</Link></li>
                <li><Link href='/' className='focus:bg-f1 hover:bg-f1 border-1 p-2 rounded-lg'>Request a quote</Link></li>
            </ul>
            </nav>
        </div>
        </section>

        <nav className={`absolute w-full pb-2 bg-white ${active ? "flex":'hidden'}`}>
